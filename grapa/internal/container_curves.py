...
class CurveContainer:
    ...
    def _typecheck_raise(self, curve) -> bool:
        ...
        if not isinstance(curve, Curve):
            raise TypeError("Only Curve objects can be added to CurveContainer.")
        return True
    ...
    def __setitem__(self, c: int, new):
        """May raise TypeError, or any error of list.__setitem__()"""
    ...
    def insert(self, c: int, curve):
        ...
        May raise TypeError, or any error of list.insert()."""
    ...
    def append(self, curve: Union["Curve", list, tuple, "Graph"]):
        ...
        May raise TypeError, or any error of list.append()."""
        from grapa.graph import Graph
