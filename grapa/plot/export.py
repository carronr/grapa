...
from grapa.shared.error_management import issue_warning, FileNotCreatedError
from grapa.shared.keywords_loader import keywords_curve
from grapa.shared.string_manipulations import varToStr
...
class GraphExporter:
    """A library of functions useful to export Graphs into a txt file.
    ...
    def export_as_text(
        ...
        graph.filename = os.path.normpath(filename)
