...
from grapa.shared.command_recorder import (
    Action,
    Command,
...
def test_command_recorder_in_curve_setx_indexnone(graph2):
    """test command recorder in Curve.set_x with index=None, undo and redo"""
    curve = graph2[0]
    curve.set_x([7, 8, 9])
    graph2.recorder.tag_as_end_transaction()
...
def test_command_recorder_in_curve_setx_indexwith0(graph2):
    """test command recorder in Curve.set_x with index provided, undo and redo"""
    curve = graph2[0]
    curve.set_x([8], index=[1])
    graph2.recorder.tag_as_end_transaction()
...
def test_command_recorder_in_curve_setx_indexwith1(graph2):
    """test command recorder in Curve.set_x with index provided, undo and redo"""
    curve = graph2[0]
    curve.set_x([8, 9], index=range(1, 3))
    graph2.recorder.tag_as_end_transaction()
...
def test_command_recorder_in_curve_sety_indexnone(graph1):
    """test command recorder in Curve.set_y with index=None, undo and redo"""
    curve = graph1[0]
    curve.set_y([7, 8])
    graph1.recorder.tag_as_end_transaction()
...
def test_command_recorder_in_curve_sety_indexwith(graph2):
    """test command recorder in Curve.set_y with index provided, undo and redo"""
    curve = graph2[0]
    curve.set_y([7, 9], index=(0, 2))
    graph2.recorder.tag_as_end_transaction()
